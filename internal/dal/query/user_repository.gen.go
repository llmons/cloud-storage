...
import (
	...
	"cloud-storage/internal/dal/model"
)
...
func newUserRepository(db *gorm.DB, opts ...gen.DOOption) userRepository {
	...
	_userRepository.userRepositoryDo.UseModel(&model.UserRepository{})
...
type IUserRepositoryDo interface {
	...
	Create(values ...*model.UserRepository) error
	CreateInBatches(values []*model.UserRepository, batchSize int) error
	Save(values ...*model.UserRepository) error
	First() (*model.UserRepository, error)
	Take() (*model.UserRepository, error)
	Last() (*model.UserRepository, error)
	Find() ([]*model.UserRepository, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.UserRepository, err error)
	FindInBatches(result *[]*model.UserRepository, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.UserRepository) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.UserRepository, error)
	FirstOrCreate() (*model.UserRepository, error)
	FindByPage(offset int, limit int) (result []*model.UserRepository, count int64, err error)
...
func (u userRepositoryDo) Create(values ...*model.UserRepository) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userRepositoryDo) CreateInBatches(values []*model.UserRepository, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userRepositoryDo) Save(values ...*model.UserRepository) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userRepositoryDo) First() (*model.UserRepository, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.UserRepository), nil
	}
}

func (u userRepositoryDo) Take() (*model.UserRepository, error) {
...
func (u userRepositoryDo) Last() (*model.UserRepository, error) {
...
func (u userRepositoryDo) Find() ([]*model.UserRepository, error) {
	result, err := u.DO.Find()
	return result.([]*model.UserRepository), err
}

func (u userRepositoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.UserRepository, err error) {
	buf := make([]*model.UserRepository, 0, batchSize)
...
func (u userRepositoryDo) FindInBatches(result *[]*model.UserRepository, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userRepositoryDo) FirstOrInit() (*model.UserRepository, error) {
...
func (u userRepositoryDo) FirstOrCreate() (*model.UserRepository, error) {
...
func (u userRepositoryDo) FindByPage(offset int, limit int) (result []*model.UserRepository, count int64, err error) {
...
func (u userRepositoryDo) Delete(models ...*model.UserRepository) (result gen.ResultInfo, err error) {
