...
type IRepositoryPoolDo interface {
	...
	Create(values ...*model.RepositoryPool) error
	CreateInBatches(values []*model.RepositoryPool, batchSize int) error
	Save(values ...*model.RepositoryPool) error
	First() (*model.RepositoryPool, error)
	Take() (*model.RepositoryPool, error)
	Last() (*model.RepositoryPool, error)
	Find() ([]*model.RepositoryPool, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.RepositoryPool, err error)
	FindInBatches(result *[]*model.RepositoryPool, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.RepositoryPool) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.RepositoryPool, error)
	FirstOrCreate() (*model.RepositoryPool, error)
	FindByPage(offset int, limit int) (result []*model.RepositoryPool, count int64, err error)
