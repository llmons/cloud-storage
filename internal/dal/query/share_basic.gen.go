...
func newShareBasic(db *gorm.DB, opts ...gen.DOOption) shareBasic {
	...
	_shareBasic.shareBasicDo.UseModel(&model.ShareBasic{})
...
type IShareBasicDo interface {
	...
	Create(values ...*model.ShareBasic) error
	CreateInBatches(values []*model.ShareBasic, batchSize int) error
	Save(values ...*model.ShareBasic) error
	First() (*model.ShareBasic, error)
	Take() (*model.ShareBasic, error)
	Last() (*model.ShareBasic, error)
	Find() ([]*model.ShareBasic, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.ShareBasic, err error)
	FindInBatches(result *[]*model.ShareBasic, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.ShareBasic) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.ShareBasic, error)
	FirstOrCreate() (*model.ShareBasic, error)
	FindByPage(offset int, limit int) (result []*model.ShareBasic, count int64, err error)
...
func (s shareBasicDo) Create(values ...*model.ShareBasic) error {
	if len(values) == 0 {
		return nil
	}
...
func (s shareBasicDo) CreateInBatches(values []*model.ShareBasic, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s shareBasicDo) Save(values ...*model.ShareBasic) error {
	if len(values) == 0 {
		return nil
	}
...
func (s shareBasicDo) First() (*model.ShareBasic, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.ShareBasic), nil
	}
}

func (s shareBasicDo) Take() (*model.ShareBasic, error) {
...
func (s shareBasicDo) Last() (*model.ShareBasic, error) {
...
func (s shareBasicDo) Find() ([]*model.ShareBasic, error) {
	result, err := s.DO.Find()
	return result.([]*model.ShareBasic), err
}

func (s shareBasicDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.ShareBasic, err error) {
	buf := make([]*model.ShareBasic, 0, batchSize)
...
func (s shareBasicDo) FindInBatches(result *[]*model.ShareBasic, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s shareBasicDo) FirstOrInit() (*model.ShareBasic, error) {
...
func (s shareBasicDo) FirstOrCreate() (*model.ShareBasic, error) {
...
func (s shareBasicDo) FindByPage(offset int, limit int) (result []*model.ShareBasic, count int64, err error) {
...
func (s shareBasicDo) Delete(models ...*model.ShareBasic) (result gen.ResultInfo, err error) {
