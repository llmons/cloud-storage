...
func newUserBasic(db *gorm.DB, opts ...gen.DOOption) userBasic {
	...
	_userBasic.userBasicDo.UseModel(&entity.UserBasic{})
...
type IUserBasicDo interface {
	...
	Create(values ...*entity.UserBasic) error
	CreateInBatches(values []*entity.UserBasic, batchSize int) error
	Save(values ...*entity.UserBasic) error
	First() (*entity.UserBasic, error)
	Take() (*entity.UserBasic, error)
	Last() (*entity.UserBasic, error)
	Find() ([]*entity.UserBasic, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.UserBasic, err error)
	FindInBatches(result *[]*entity.UserBasic, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entity.UserBasic) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entity.UserBasic, error)
	FirstOrCreate() (*entity.UserBasic, error)
	FindByPage(offset int, limit int) (result []*entity.UserBasic, count int64, err error)
...
func (u userBasicDo) Create(values ...*entity.UserBasic) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userBasicDo) CreateInBatches(values []*entity.UserBasic, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userBasicDo) Save(values ...*entity.UserBasic) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userBasicDo) First() (*entity.UserBasic, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.UserBasic), nil
	}
}

func (u userBasicDo) Take() (*entity.UserBasic, error) {
...
func (u userBasicDo) Last() (*entity.UserBasic, error) {
...
func (u userBasicDo) Find() ([]*entity.UserBasic, error) {
	result, err := u.DO.Find()
	return result.([]*entity.UserBasic), err
}

func (u userBasicDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.UserBasic, err error) {
	buf := make([]*entity.UserBasic, 0, batchSize)
...
func (u userBasicDo) FindInBatches(result *[]*entity.UserBasic, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userBasicDo) FirstOrInit() (*entity.UserBasic, error) {
...
func (u userBasicDo) FirstOrCreate() (*entity.UserBasic, error) {
...
func (u userBasicDo) FindByPage(offset int, limit int) (result []*entity.UserBasic, count int64, err error) {
...
func (u userBasicDo) Delete(models ...*entity.UserBasic) (result gen.ResultInfo, err error) {
